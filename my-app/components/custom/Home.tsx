export default function Home() {
  return (
    <div className="h-screen flex flex-col justify-center gap-6 text-center m-4">
      <img
        src="https://avatars.githubusercontent.com/u/73852736?v=4"
        className=" rounded-full self-center w-1/5 md:w-1/6"
      ></img>
      <h1 className="text-4xl font-bold tracking-wide">
        Hey, Muntasir Mallik here 👋.
      </h1>
      <div>
        <h2 className="text-2xl m-2">Full Stack Web Developer</h2>
        <p className=" m-2 text-sm">
          This website is still in works. Till then, here are some useful links.
        </p>
        <div className="relative"></div>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 mx-6 gap-4">
        <a href="https://github.com/muntaxir4" target="_blank">
          <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block w-full">
            ...
            <div className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-2 px-4 ring-1 ring-white/10 justify-center">
              <span className="text-xl hover:tracking-widest">Github</span>
              <svg
                fill="none"
                height="16"
                viewBox="0 0 24 24"
        ...
        <a href="https://linkedin.com/in/muntasir-mallik" target="_blank">
          <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block w-full">
            <span className="absolute inset-0 overflow-hidden rounded-full">
              <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
            </span>
            <div className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-2 px-4 ring-1 ring-white/10 justify-center">
              <span className="text-xl hover:tracking-widest">LinkedIn</span>
              <svg
                fill="none"
                height="16"
                viewBox="0 0 24 24"
        ...
        <a href="https://x.com/muntaxir04" target="_blank">
          <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block w-full">
            <span className="absolute inset-0 overflow-hidden rounded-full">
              <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
            </span>
            <div className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-2 px-4 ring-1 ring-white/10 justify-center">
              <span className="text-xl hover:tracking-widest">X</span>
              <svg
                fill="none"
                height="16"
                viewBox="0 0 24 24"
        ...
        <a href="https://leetcode.com/u/muntaxir" target="_blank">
          <button className="bg-slate-800 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-xs font-semibold leading-6  text-white inline-block w-full">
            <span className="absolute inset-0 overflow-hidden rounded-full">
              <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(56,189,248,0.6)_0%,rgba(56,189,248,0)_75%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
            </span>
            <div className="relative flex space-x-2 items-center z-10 rounded-full bg-zinc-950 py-2 px-4 ring-1 ring-white/10 justify-center">
              <span className="text-xl hover:tracking-widest">LeetCode</span>
              <svg
                fill="none"
                height="16"
                viewBox="0 0 24 24"
